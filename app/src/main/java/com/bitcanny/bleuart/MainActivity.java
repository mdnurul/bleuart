...
import com.bitcanny.bleuart.data.Util;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listDev = (ListView) findViewById(R.id.listViewDevices);
        textViewRecv = (TextView) findViewById(R.id.textViewRecv);
        editTextSend = (EditText) findViewById(R.id.editText3);
        //setContentView(list);
        ...
        listDev.setAdapter(mConnectedDevicesAdapter);
    ...
    public void StopAdvtOnClick(View view) {

        shutdownServer();

    }

    public void StartAdvtOnClick(View view) {
    ...
    public void SendDataOnclick(View view) {
        ...
        String data_to_send = editTextSend.getText().toString();
        sendOurResponse(data_to_send);
 ...
 */
    ...
    */
    private BluetoothGattServerCallback mGattServerCallback = new BluetoothGattServerCallback() {
        ...
        public void onCharacteristicWriteRequest(BluetoothDevice device,
            ...
            if (UARTProfile.RX_WRITE_CHAR.equals(characteristic.getUuid())) {
                ...
                Log.d(TAG, "Received data: " + bytesToHex(value)+" Msg: "+storage);


                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        textViewRecv.setText(myRec);
                        //Toast.makeText(MainActivity.this, "We received data: "+myRec, Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    //Send notification to all the devices once you write
    private void sendOurResponse(String data) {
        for (BluetoothDevice device : mConnectedDevices) {
            BluetoothGattCharacteristic readCharacteristic = mGattServer.getService(UARTProfile.UART_SERVICE)
                    .getCharacteristic(UARTProfile.TX_READ_CHAR);
